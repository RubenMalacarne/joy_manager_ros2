    ...
    delayed_joystick_node = TimerAction(
        ...
        actions=[
            Node(
                ...
                output='screen',
                parameters=[{
                    'roll_topic': 'joystick/roll', #axis 2
                    'pitch_topic': 'joystick/pitch', #axis 3
                    'yaw_topic': 'joystick/yaw', #axis 0
                    'thrust_topic': 'joystick/thrust', #axis 1
                    'gear_S1_topic': 'joystick/gear_S1', #axis 4
                    'switch_SC_service': 'joystick/switch_SC', #axis 6
                    'switch_SB_service': 'joystick/switch_SB', #axis 5
                    ...
                    'axis_0_min': 1.0, 'axis_0_max': -1.0,  # Roll (fisicamente axis 2, ma usa index 0 per remap)
                    'axis_1_min': -1.0, 'axis_1_max': 1.0,  # Pitch (fisicamente axis 3, ma usa index 1 per remap)
                    ...
                    'axis_4_min': -1.0, 'axis_4_max': 1.0,   # Gear S1 (axis 4)
